...
let style = ''
let project = {}
class allpunchings extends React.Component {
    constructor() {
        super()
        this.state = {
            accounts: ''
                                    ...
                                    <div className="row">
                                        {
                                            (projects.length === 0)
                                                ...
                                                : projects.map((item, index) => {
                                                    return (
                                                        <div className="card col-4 mb-4 py-3 border-left-warning m-2">
                                                            ...
                                                            <div className="card-body">
                                                                <Link className="btn btn-info"
                                                                    to={{ pathname: '/punching_detail/' + index }}>View Details</Link>
                                                            </div>
                                                        </div>
                                                    )
                                                }, this)
